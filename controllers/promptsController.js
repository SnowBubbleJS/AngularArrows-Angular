...
function promptsController ($scope) {
  ...
  $scope.prompts =
  [
    "In order for your Angular application to work, we will have to initialize the application in our HTML file and to do so we attach a specific attribute to a DOM element where we want our Angular application to appear. ng-app is commonly given as an attribute to either <html> or <body> element, but for the purposes of our tutorial we will attach it to the <html> element. Please give ng-app the value of myApp.",
